...
/datum/outfit/job/hosv
	name = "Head of Service"
	jobtype = /datum/job/hosv

	id = /obj/item/card/id/silver
	belt = /obj/item/pda/heads/hop
	ears = /obj/item/radio/headset/heads/hosv
