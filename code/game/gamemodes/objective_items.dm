...
/datum/objective_item/steal/caplaser
	...
	difficulty = 5
	excludefromjob = list("Captain", "Bridge Officer") //Non-modular changes

/datum/objective_item/steal/hoslaser
	name = "the head of security's personal laser gun."
	targetitem = /obj/item/gun/energy/e_gun/hos
	difficulty = 10
	excludefromjob = list("Head Of Security", "Bridge Officer") //Non-modular changes

/datum/objective_item/steal/handtele
	name = "a hand teleporter."
	targetitem = /obj/item/hand_tele
	difficulty = 5
	excludefromjob = list("Captain", "Research Director", "Bridge Officer") //Non-modular changes
...
/datum/objective_item/steal/reflector
	...
	difficulty = 3
	excludefromjob = list("Head of Security", "Warden", "Bridge Officer") //Non-modular changes
...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list("Chief Engineer","Research Director","Station Engineer","Scientist","Atmospheric Technician", "Toxicologist", "Xenobiologist") //Non-modular changes
...
/datum/objective_item/steal/slime
	...
	difficulty = 3
	excludefromjob = list("Research Director","Scientist", "Xenobiologist") //Non-modular changes
