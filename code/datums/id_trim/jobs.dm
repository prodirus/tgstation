...
/datum/id_trim/job/quartermaster
	...
	access = list(ACCESS_MAINT_TUNNELS, ACCESS_MAILSORTING, ACCESS_CARGO, ACCESS_QM, ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION, 
					ACCESS_MINERAL_STOREROOM, ACCESS_VAULT, ACCESS_AUX_BASE, ACCESS_HEADS, ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_CHANGE_IDS, ACCESS_ENGINE, ACCESS_RND, ACCESS_RESEARCH) //NON-MODULAR CHANGES
	minimal_access = list(ACCESS_MAINT_TUNNELS, ACCESS_MAILSORTING, ACCESS_CARGO, ACCESS_QM, ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION, 
					ACCESS_MINERAL_STOREROOM, ACCESS_VAULT, ACCESS_AUX_BASE, ACCESS_HEADS, ACCESS_SEC_DOORS, ACCESS_SECURITY,ACCESS_CHANGE_IDS, ACCESS_ENGINE) //NON-MODULAR CHANGES
...
/datum/id_trim/job/scientist
	...
	minimal_access = list(ACCESS_RND, ACCESS_RESEARCH, ACCESS_MECH_SCIENCE,
